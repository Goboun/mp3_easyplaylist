...
iconButton1 = PhotoImage(file="library/images/icon-metadata.png")
iconButton2 = PhotoImage(file="library/images/dossier.png")
iconButton3 = PhotoImage(file="library/images/playlist.png")
iconButton4 = PhotoImage(file="library/images/loupe.png")
iconExport = PhotoImage(file="library/images/icon-export.png")
...
photo = PhotoImage(file="library/images/music_note.png")
    ...
    if not file_path:
        ...
        if(type == "audio/mpeg" or type == "audio/flac" or type == "audio/x-flac"):
            ...
            if hasattr(musique["artwork"].first, "data"):
                ...
                with open("library/images/cover.jpeg", "wb") as f:
                    f.write(image_donnee)
                image = Image.open("library/images/cover.jpeg")
            else:
                image = Image.open("library/images/sans_cover.jpeg")
            ...
            image = Image.open("library/images/play.jpeg")
            image.thumbnail((50, 50))
            play_image = ImageTk.PhotoImage(image)
            image = Image.open("library/images/stop.jpeg")
            image.thumbnail((50, 50))
    ...
    def show_album(album):
        ...
        if data.status_code == 200:
            ...
            if response.status_code == 200:
                with open("library/images/cover.jpg", "wb") as file:
                    file.write(response.content)
                image = Image.open("library/images/cover.jpg")
                cover_image = ImageTk.PhotoImage(image)
